                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <div className="flex items-center gap-3 my-2">
                            <p className="flex items-center">
                                ...
                                <Link
                                    ...
                                    href="https://github.com/svssdeva/quiz"
                                >
                                    GitHub
                                </Link>
                            </p>
                            <p className="flex items-center">
                                ...
                                <Link
                                    className="ml-1 underline"
                                    href="https://www.linkedin.com/in/deveshwar-jaiswal-frontendninja/"
                                >
                                    LinkedIn
                                </Link>
                            </p>
                        ...
                        <p className="my-2 mt-4 ">
                            ...
                            the ordinary and embrace the extraordinary with Quiz App! Our
